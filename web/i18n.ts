...
const english = {
  ...
  useAsInput: "Use as new input",
  copyFile: "Copy file",
  copied: "Copied",
  pressCopy: "Press Ctrl/Cmd+C",
  downloadFile: "Download file",
  downloadAll: "Download all (.tar)",
  formatted: "Formatted",
  ...
  tarPath: "Paths must fit the portable tar name fields (100-byte name and 155-byte prefix).",
...
const messages: Record<Locale, Record<MessageKey, string>> = {
  ...
  pt: {
    ...
    useAsInput: "Usar como nova entrada",
    copyFile: "Copiar arquivo",
    copied: "Copiado",
    pressCopy: "Pressione Ctrl/Cmd+C",
    downloadFile: "Baixar arquivo",
    downloadAll: "Baixar tudo (.tar)",
    formatted: "Formatado",
    ...
    tarPath: "Os caminhos devem caber nos campos tar portáteis (nome de 100 bytes e prefixo de 155 bytes).",
  ...
  es: {
    ...
    useAsInput: "Usar como nueva entrada",
    copyFile: "Copiar archivo",
    copied: "Copiado",
    pressCopy: "Pulsa Ctrl/Cmd+C",
    downloadFile: "Descargar archivo",
    downloadAll: "Descargar todo (.tar)",
    ...
    tarPath: "Las rutas deben caber en los campos tar portátiles (nombre de 100 bytes y prefijo de 155 bytes).",
  ...
  fr: {
    ...
    useAsInput: "Utiliser comme nouvelle entrée",
    copyFile: "Copier le fichier",
    copied: "Copié",
    pressCopy: "Appuyez sur Ctrl/Cmd+C",
    downloadFile: "Télécharger le fichier",
    downloadAll: "Tout télécharger (.tar)",
    formatted: "Formaté",
    ...
    tarPath: "Les chemins doivent tenir dans les champs tar portables (nom de 100 octets et préfixe de 155 octets).",

...
const english = {
  ...
  identityPrivacy: "Stored only in this browser. It is sent to WebAssembly in this tab, never to a server.",
  ...
  wasmRequired: "WASM build required",
  wasmBuildHelp: "Build the playground module first; see web/README.md.",
  ...
  notChecked: "Not checked here: the official Norminette and the C compiler. This page has neither, so what is listed above is only what the parser could prove. A clean result is not a passing grade.",
  next: "Next",
...
const messages: Record<Locale, Record<MessageKey, string>> = {
  ...
  pt: {
    ...
    identityPrivacy: "Salvo apenas neste navegador. É enviado ao WebAssembly nesta aba, nunca a um servidor.",
    ...
    wasmReady: "WASM pronto",
    wasmRequired: "Build WASM necessário",
    wasmBuildHelp: "Compile o módulo do playground primeiro; consulte web/README.md.",
    ...
    notChecked: "Não verificado aqui: a Norminette oficial e o compilador C. Esta página não tem nenhum dos dois, então o que está acima é só o que o parser conseguiu provar. Resultado limpo não é aprovação.",
    next: "Próximo passo",
  ...
  es: {
    ...
    identityPrivacy: "Se guarda solo en este navegador. Se envía a WebAssembly en esta pestaña, nunca a un servidor.",
    ...
    wasmRequired: "Se necesita el build WASM",
    wasmBuildHelp: "Compila primero el módulo del playground; consulta web/README.md.",
    ...
    notChecked: "No se verificó aquí: la Norminette oficial ni el compilador C. Esta página no tiene ninguno de los dos, así que lo de arriba es solo lo que el parser pudo demostrar. Un resultado limpio no es una aprobación.",
    next: "Siguiente paso",
  ...
  fr: {
    ...
    identityPrivacy: "Stocké uniquement dans ce navigateur. Envoyé au WebAssembly de cet onglet, jamais à un serveur.",
    ...
    wasmReady: "WASM prêt",
    wasmRequired: "Build WASM requis",
    wasmBuildHelp: "Compilez d’abord le module du playground ; consultez web/README.md.",
    ...
    notChecked: "Non vérifié ici : la Norminette officielle et le compilateur C. Cette page n’a ni l’une ni l’autre : ce qui précède est seulement ce que l’analyseur a pu prouver. Un résultat propre n’est pas une validation.",
    next: "Étape suivante",

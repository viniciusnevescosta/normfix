...
use normfix_destructive::{
    ...
    StaticRemovalPlan, plan_orphan_prototypes, plan_unused_static_functions,
};
use normfix_header::{
...
mod tests {
    ...
    use super::{
        MAKEFILE_TRIVIA_PROBE_LIMIT, PlannedFile, dependent_destructive_bundle_is_partial,
        load_destructive_source, makefile_source_path, makefile_source_probe, prelude_entry,
    };

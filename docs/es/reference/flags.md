...
El diff unificado conserva los bytes de tabulación literales, por lo que
copiarlo o aplicarlo mantiene exactamente el código propuesto. Mutuamente
excluyente con `--check`.

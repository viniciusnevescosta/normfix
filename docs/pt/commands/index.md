...
| [`leaks`](/pt/commands/leaks) | não | Você quer um programa que construiu verificado contra vazamentos |
...
A saída mostrada foi produzida por `normfix 1.9.1` sobre este arquivo:

        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: "Processo de release", link: "/RELEASING" },
            ],
          },
          {
            text: "Projeto",
            items: [
              { text: "Changelog", link: "/changelog" },
              { text: "Contribuir", link: "/contributing" },
              { text: "Política de segurança", link: "/security" },
              { text: "Roadmap", link: "/ROADMAP" },
        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: "Proceso de publicación", link: "/RELEASING" },
            ],
          },
          {
            text: "Proyecto",
            items: [
              { text: "Changelog", link: "/changelog" },
              { text: "Contribuir", link: "/contributing" },
              { text: "Política de seguridad", link: "/security" },
              { text: "Roadmap", link: "/ROADMAP" },
        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: "Processus de publication", link: "/RELEASING" },
            ],
          },
          {
            text: "Projet",
